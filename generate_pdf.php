...
if (isset($_GET['gen_pdf']) && isset($_GET['id'])) {
  ...
  $table_data = "
    ...
    <table border='1' >
      ...
      <tr>
        ...
        <td>Cost: " . number_format($data['price'], 0, '.', ',') . " đ/đêm</td>
      </tr>
      <tr>
  ...
  if ($data['booking_status'] == 'cancelled') {
    ...
    $table_data .= "
    <tr>
      <td>Amount Paid: " . number_format($data['trans_amt'], 0, '.', ',') . "đ</td>
      <td>Refund: $refund</td>
    </tr>";
  } else if ($data['booking_status'] == 'payment failed') {
    $table_data .= "
    <tr>
      <td>Transaction Amount: " . number_format($data['trans_amt'], 0, '.', ',') . "đ</td>

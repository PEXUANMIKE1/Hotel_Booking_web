...
if (isset($_POST['get_bookings'])) {
  ...
  while ($data = mysqli_fetch_assoc($limit_res)) {
    ...
    $table_data .= "
      <tr>
        ...
        <td>
          <button type='button' onclick='download($data[booking_id])' class='btn btn-outline-success btn-sm fw-bold shadow-none mt-2'>
  ...
  $pagination = "";
  if ($total_rows > $limit) {
    $total_pages = ceil($total_rows / $limit); //hàm ceil() sẽ làm tròn lên VD: 7/5 = 1,4 sẽ làm tròn = 2;

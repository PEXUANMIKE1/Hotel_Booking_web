      ...
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            ...
            <form id="general_s_form">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" onclick="site_title.value = general_data.site_title, site_about.value = general_data.site_about" 
        ...
        <div class="card-body">
          ...
          <p class="card-text" id="site_title">
            Khi website bị tắt hoạt động, không có khách hàng nào được phép đặt phòng khách sạn.
          </p>
        </div>
        </div>
